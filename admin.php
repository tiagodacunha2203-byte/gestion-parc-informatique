...
<head>
    ...
    <style>
        ...
        /* Buttons */
        .btn { display: inline-block; background: #27ae60; color: white; border: none; padding: 12px 25px; border-radius: 6px; cursor: pointer; font-weight: bold; font-size: 15px; text-decoration: none; }
        ...
        .card-close { color: #e74c3c; text-decoration: none; font-weight: bold; position: absolute; top: 20px; right: 20px; }
...
<div class="container">
    ...
    <?php if ($selected): ?>
    <div class="card">
        <a href="index.php" class="card-close">✖ Fermer</a>
        ...
        <div class="card-actions">
            ...
            <a href="delete.php?id=<?php echo $selected['id']; ?>"
               ...
               onclick="return confirm('Supprimer cet équipement ? Cette action est irréversible.')">
               🗑️ Supprimer
            </a>
        </div>
    </div>
